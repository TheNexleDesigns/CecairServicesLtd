...
(function(){
  ...
  window.RAC_GALLERY_SETS = [
    ...
    set('Mobile Compressor Replacement', 'Auto · 2010 Hyundai Tucson', STEEL,
      '<picture><source srcset="assets/tucson-compressor-cover.webp" type="image/webp"><img src="assets/tucson-compressor-cover.jpg" alt="2010 Hyundai Tucson A/C compressor replacement"></picture>',
      ['<video src="assets/tucson-compressor-repair.mp4" controls playsinline preload="metadata" poster="assets/tucson-compressor-cover.jpg"></video>'],
      [
        "This 2010 Hyundai Tucson had lost its cold air — our mobile team supplied and installed a new original compressor, along with a fresh drier and expansion valve, right at the customer's location."
      ]
    ),
    set('Whole-Home Multi-Zone Split Install', 'Home · Multiple Rooms', ICE,
      '<picture><source srcset="assets/multizone-outdoor-units.webp" type="image/webp"><img src="assets/multizone-outdoor-units.jpg" alt="Two outdoor condenser units mounted for a whole-home multi-zone split install"></picture>',
      [
        '<picture><source srcset="assets/multizone-outdoor-units.webp" type="image/webp"><img src="assets/multizone-outdoor-units.jpg" alt="Two outdoor condenser units mounted for a whole-home multi-zone split install"></picture>',
        '<picture><source srcset="assets/multizone-bedroom-1.webp" type="image/webp"><img src="assets/multizone-bedroom-1.jpg" alt="Indoor unit installed in bedroom one"></picture>',
        '<picture><source srcset="assets/multizone-bedroom-2.webp" type="image/webp"><img src="assets/multizone-bedroom-2.jpg" alt="Indoor unit installed in bedroom two"></picture>',
        '<picture><source srcset="assets/multizone-bedroom-3.webp" type="image/webp"><img src="assets/multizone-bedroom-3.jpg" alt="Indoor unit installed in bedroom three"></picture>',
        '<picture><source srcset="assets/multizone-bedroom-4.webp" type="image/webp"><img src="assets/multizone-bedroom-4.jpg" alt="Indoor unit installed in bedroom four"></picture>',
        '<picture><source srcset="assets/multizone-bedroom-5.webp" type="image/webp"><img src="assets/multizone-bedroom-5.jpg" alt="Indoor unit installed in bedroom five"></picture>'
      ],
      [
        'Two outdoor condensers mounted together on the exterior wall, powering every indoor zone in the home.',
        'Indoor unit installed and finished cleanly in the first bedroom.',
        'A second bedroom, fitted with its own dedicated indoor unit.',
        'A third room covered, matched neatly to the ceiling trim.',
        'A fourth zone installed, keeping every room independently controlled.',
        'The fifth and final indoor unit, completing a whole-home multi-zone installation.'
      ]
    ),
    set('24,000 BTU Split Install', 'Home & Business · Mini Condensate Pump', ICE,
      '<picture><source srcset="assets/yonan-24k-outdoor.webp" type="image/webp"><img src="assets/yonan-24k-outdoor.jpg" alt="24,000 BTU Yonan outdoor condenser installed"></picture>',
      [
        '<picture><source srcset="assets/yonan-24k-indoor.webp" type="image/webp"><img src="assets/yonan-24k-indoor.jpg" alt="24,000 BTU Yonan indoor unit installed"></picture>',
        '<picture><source srcset="assets/yonan-24k-condensate-pump.webp" type="image/webp"><img src="assets/yonan-24k-condensate-pump.jpg" alt="Mini condensate pump fitted inside the indoor unit housing"></picture>',
        '<picture><source srcset="assets/yonan-24k-outdoor.webp" type="image/webp"><img src="assets/yonan-24k-outdoor.jpg" alt="24,000 BTU Yonan outdoor condenser installed"></picture>'
      ],
      [
        '24,000 BTU Yonan indoor unit mounted, with ducted trunking routing the lines cleanly along the ceiling.',
        'A mini condensate pump fitted inside the housing to actively drain condensate where gravity alone wasn\u2019t enough.',
        'Outdoor condenser installed and charged, gauges connected for final commissioning and hand-over.'
      ]
    ),
    set('Cool Comfort, Delivered', 'Home & Business · Our Services', ICE,
      '<picture><source srcset="assets/team-service-truck.webp" type="image/webp"><img src="assets/team-service-truck.jpg" alt="Reliable Air Conditioning branded service truck"></picture>',
      [
        '<picture><source srcset="assets/team-service-truck.webp" type="image/webp"><img src="assets/team-service-truck.jpg" alt="Reliable Air Conditioning branded service truck"></picture>',
        '<picture><source srcset="assets/team-indoor-unit.webp" type="image/webp"><img src="assets/team-indoor-unit.jpg" alt="Newly installed indoor split A/C unit"></picture>',
        '<picture><source srcset="assets/team-outdoor-units.webp" type="image/webp"><img src="assets/team-outdoor-units.jpg" alt="Two outdoor A/C condenser units installed on exterior wall"></picture>'
      ],
      [
        'Our fully equipped service vehicles bring everything needed for commercial, industrial, residential, and automotive A/C work directly to you.',
        'A clean, professional indoor unit installation — mounted level and finished neatly for a seamless look.',
        'Outdoor condensers installed and wired, built to handle the job for years to come.'
      ]
    ),
    set('Compressor & Condenser Repair', 'Auto · Our Services', STEEL,
      '<picture><source srcset="assets/compressor-condenser-service.webp" type="image/webp"><img src="assets/compressor-condenser-service.jpg" alt="Auto A/C compressor and condenser repair services"></picture>',
      ['<picture><source srcset="assets/compressor-condenser-service.webp" type="image/webp"><img src="assets/compressor-condenser-service.jpg" alt="Auto A/C compressor and condenser repair services"></picture>'],
      [
        'From compressor replacements to condenser repairs, we diagnose and fix the root cause of warm-air A/C problems — parts sourced, fitted, and tested on site or at our shop.'
      ]
    ),
    set('Mobile Evaporator Replacement', 'Auto · Audi A7', STEEL,
      '<picture><source srcset="assets/audi-evaporator-cover.webp" type="image/webp"><img src="assets/audi-evaporator-cover.jpg" alt="Audi A7 A/C evaporator replacement"></picture>',
      ['<video src="assets/audi-evaporator-repair.mp4" controls playsinline preload="metadata" poster="assets/audi-evaporator-cover.jpg"></video>'],
      [
        'A full evaporator replacement on this Audi A7, carried out as a mobile visit — no need to bring the car in, we come to you anywhere, for any make or model.'
      ]
    ),
    set('5-Ton Ducted + 18,000 BTU Split Install', 'Home & Business · New Install', ICE,
      '<picture><source srcset="assets/ducted-split-install-outdoor.webp" type="image/webp"><img src="assets/ducted-split-install-outdoor.jpg" alt="Outdoor condenser units for 5-ton ducted and 18,000 BTU split system"></picture>',
      [
        '<picture><source srcset="assets/ducted-split-install-indoor.webp" type="image/webp"><img src="assets/ducted-split-install-indoor.jpg" alt="Indoor air handler for the new 5-ton ducted system"></picture>',
        '<picture><source srcset="assets/ducted-split-install-outdoor.webp" type="image/webp"><img src="assets/ducted-split-install-outdoor.jpg" alt="Outdoor condenser units for 5-ton ducted and 18,000 BTU split system"></picture>',
        '<picture><source srcset="assets/ducted-split-install-thermostat.webp" type="image/webp"><img src="assets/ducted-split-install-thermostat.jpg" alt="Honeywell Home thermostat commissioned for the ducted system"></picture>'
      ],
      [
        'Indoor air handler for the new 5-ton ducted system, mounted with a proper condensate line and full clearance for servicing.',
        'Both outdoor condensers installed and wired — the 5-ton unit paired with an 18,000 BTU split system for full coverage.',
        'Honeywell Home thermostat commissioned to give simple, precise control over the ducted system.'
      ]
    ),
  ...
  window.RAC_BEFORE_AFTER = {
    before: '<picture><source srcset="assets/ge-split-install-before.webp" type="image/webp"><img src="assets/ge-split-install-before.jpg" alt="Exterior wall before A/C installation" loading="lazy" decoding="async"></picture>',
    after: '<picture><source srcset="assets/ge-split-install-after.webp" type="image/webp"><img src="assets/ge-split-install-after.jpg" alt="Two GE split A/C outdoor units installed on the same wall" loading="lazy" decoding="async"></picture>'
  };
